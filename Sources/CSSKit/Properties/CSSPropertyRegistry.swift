...
#CSSPropertyEnum {
    ...
    _ = ("text-decoration-skip-ink", CSSTextDecorationSkipInk.self, CSSPropertyFlags.inherits)
    _ = ("text-underline-offset", CSSTextUnderlineOffset.self, CSSPropertyFlags.inherits)
    _ = ("text-underline-position", CSSTextUnderlinePosition.self, CSSPropertyFlags.inherits)
